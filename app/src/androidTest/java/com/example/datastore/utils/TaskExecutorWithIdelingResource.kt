...
/**
 * A Junit rule that registers Architecture's Components' background threads as Espresso idling
 * resource.
 */
class TaskExecutorWithIdlingResource : CountingTaskExecutorRule() {
    // give it a unique id to workaround an espresso bug where you cannot register/unregister
    // an idling resource w/ same name.
    ...
    private val idlingResource = object : IdlingResource {
        ...
        override fun isIdleNow(): Boolean {
            return this@TaskExecutorWithIdlingResource.isIdle
        }
